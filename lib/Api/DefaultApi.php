...
class DefaultApi
{
    ...
    {
        $this->accountsPostWithHttpInfo($body);
    }
     ...
     */
    public function accountsPostWithHttpInfo($body)
    {
        $returnType = '';
        $request = $this->accountsPostRequest($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function accountsPostAsync($body)
    {
        return $this->accountsPostAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function accountsPostAsyncWithHttpInfo($body)
    {
        $returnType = '';
        $request = $this->accountsPostRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function accountsPostRequest($body)
    {
